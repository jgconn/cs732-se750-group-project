...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className='relative h-1 w-full grow overflow-hidden rounded-full bg-white dark:bg-slate-50/20'>
      <SliderPrimitive.Range className='absolute h-full bg-tertiary dark:bg-slate-50' />
